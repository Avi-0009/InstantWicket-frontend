...
// --- REUSABLE COMPONENTS FOR A CLEANER LOOK ---

// 1. Section Container (Groups items together like standard app settings)
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        {/* We use your primary accent color for the icons */}
...
export default function SettingsPage() {
  ...
  return (
    <main className="p-4 md:p-6 max-w-2xl mx-auto w-full animate-fade-in pb-24 bg-[#000000]">
      <h1 className="text-[28px] font-bold text-[#F4FFFD] mb-6">Settings</h1>
      ...
      <SettingsSection title="Preferences">
        {/* Removed Dark Mode, kept Notifications */}
        <SettingsMenuItem
          icon={Bell}
      ...
      {/* Standalone Logout Button (Matches native app patterns) */}
      <div className="mt-8">
        <button
