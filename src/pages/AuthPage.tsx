...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 overflow-hidden font-sans">
      <div className="relative w-full max-w-5xl min-h-187.5 md:min-h-150 bg-card border border-border rounded-3xl overflow-hidden shadow-2xl flex flex-col md:block">
